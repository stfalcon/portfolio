 ...
 */
class Version20140610114008 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE tag_translations ADD CONSTRAINT FK_66A1F185232D562B FOREIGN KEY (object_id) REFERENCES blog_tags (id) ON DELETE CASCADE");
    }
