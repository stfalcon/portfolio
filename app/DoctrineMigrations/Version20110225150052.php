...
class Version20110225150052 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE portfolio_projects (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) ENGINE = InnoDB");
